...
public class UpdateFood extends AsyncTask {
    ...
    public UpdateFood(Context context) {
    ...
    protected Object doInBackground(Object[] objects) {
        String update_food_url = context.getString(R.string.update_food_url);
        // String reg_url = "http://10.2.3.100/eat/insert.php";
        food = (Food) objects[0];
        try {
            String data = URLEncoder.encode("id", "UTF-8") + "=" +
                    URLEncoder.encode(String.valueOf(food.getId()), "UTF-8")
            ...
            URL url = new URL(update_food_url);
